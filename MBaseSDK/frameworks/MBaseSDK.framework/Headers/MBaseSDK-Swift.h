...
#ifndef MBASESDK_SWIFT_H
#define MBASESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MBaseSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MBaseSDK17AnimatedImageView")
...
SWIFT_CLASS("_TtC8MBaseSDK16BaseAutoHeightVC")
@interface BaseAutoHeightVC : BaseVC
@property (nonatomic, weak) IBOutlet UIView * _Nullable viewContent;
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8MBaseSDK18BaseCollectionCell")
@interface BaseCollectionCell : UICollectionViewCell <DFProtocal>
- (void)awakeFromNib;
- (void)layoutSubviews;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8MBaseSDK16BaseCollectionVC")
@interface BaseCollectionVC : BaseVC <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_PROTOCOL("_TtP8MBaseSDK16BasePageProtocal_")
@protocol BasePageProtocal
@optional
- (NSArray<PageDataTemplate *> * _Nonnull)getPageDataTemplates SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC8MBaseSDK10BasePageVC")
@interface BasePageVC : BaseVC
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8MBaseSDK15BaseTableHeader")
@interface BaseTableHeader : BaseVC
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8MBaseSDK14MBAuthorCenter")
@interface MBAuthorCenter : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MBaseSDK18MBDemoPageViewerVC")
@interface MBDemoPageViewerVC : BaseVC
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MBDemoPageViewerVC (SWIFT_EXTENSION(MBaseSDK)) <UIPickerViewDataSource, UIPickerViewDelegate>
...
SWIFT_CLASS("_TtC8MBaseSDK13MBDirectoryVC")
@interface MBDirectoryVC : BaseListVC
- (void)viewDidLoad;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForHeaderInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
SWIFT_CLASS("_TtC8MBaseSDK8MBUtlity")
@interface MBUtlity : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_CLASS("_TtC8MBaseSDK16PageDataTemplate")
@interface PageDataTemplate : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8MBaseSDK11PageFactory")
...
SWIFT_CLASS("_TtC8MBaseSDK14UIDataProvider")
@interface UIDataProvider : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
