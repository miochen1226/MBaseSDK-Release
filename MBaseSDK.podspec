#
#  Be sure to run `pod spec lint MBaseSDK.podspec' to ensure this is a
...
#                   DESC
  ...
  spec.homepage     = "https://github.com/miochen1226/MBaseSDK-Release"
  ...
  spec.author             = { "mio" => "miochen1226@gmail.com" }
  # Or just: spec.author    = "mio"
  # spec.authors            = { "mio" => "miochen1226@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/mio"
  ...
  spec.source       = { :git => "https://github.com/miochen1226/MBaseSDK-Release.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "MBaseSDK/MBaseSDK/**/*.{xib}"
